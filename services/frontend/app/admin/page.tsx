...
export default function AdminPage() {
  ...
  if (session.role === "super_admin") {
    return (
      <SiteShell title="Admin Console" subtitle="Super admins are isolated from tenant dashboards.">
        <div className="notice">Use the Super Admin dashboard for platform-wide management.</div>
      </SiteShell>
    );
  }
  ...
  if (session.role === "pending" || session.userStatus === "pending") {
    return (
      <SiteShell title="Admin Console" subtitle="Approval is required before tenant admin access becomes active.">
        <div className="notice error">This account is still waiting for organization approval.</div>
      </SiteShell>
    );
  }
